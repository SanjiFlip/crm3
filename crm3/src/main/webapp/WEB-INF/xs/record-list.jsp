...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 销售管理 <span class="c-gray en">&gt;</span> 客户联系记录管理 <a class="btn btn-refresh radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
   <form action="recordctrl/selectrecord.do" method="post" id="myform">
	...
	<a href="javascript:;" onclick="member_add('添加客户联系记录','recordctrl/goaddrecord.do','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加客户联系记录</a>
  ...
  <form action="recordctrl/deleterecordall.do" method="post" id="myform1">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		<c:forEach items="${p.list}"  var="record">
			<tr class="text-c">
				...
				<a title="编辑" href="javascript:;" onclick="member_edit('编辑客户联系人','recordctrl/goaddrecord.do','${record.contactRecordId}','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
				
				<a title="删除" href="javascript:;" onclick="member_del(this,'${record.contactRecordId}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
	    </c:forEach>	
		</tbody>
	</table>
