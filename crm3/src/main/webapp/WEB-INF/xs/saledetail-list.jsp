...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 销售管理 <span class="c-gray en">&gt;</span> 销售详情单管理  <a class="btn btn-refresh radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
   <form action="detailctrl/selectdetail.do" method="post" id="myform">
	...
	<a href="javascript:;" onclick="member_add('添加销售详情','detailctrl/goadddetail.do?salesId=${salelist.salesId}','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加销售详情单</a>
