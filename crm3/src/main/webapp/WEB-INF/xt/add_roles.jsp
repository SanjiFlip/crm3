...
<article class="page-container">
	<form action="xtrolectrl/selectnotrole.do" method="post" id="myform">
		<input type="hidden" name="pageNum" id="pageNum" value="${p.pageNum }">
		<input type="hidden" name="roleId" id="roleId" value="${roleId }">
	</form>
	<form action="xtrolectrl/giverole.do" method="post" id="myform1">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				<th width="25"><input type="checkbox" name="" value=""><input type="hidden" name="roleId" id="roleId" value="${roleId }"></th>
				<th width="80">ID</th>
				<th width="100">用户名</th>
				<th width="90">员工编号</th>
				<th width="50">公司编号</th>
		...
		<a class="btn btn-primary active" aria-controls="DataTables_Table" id="DataTables_Table_previous" href="javascript:void(0)" onclick="dataadd()">赋予角色</a>
...
function dataadd(){
	if($("input[name='ids']:checked").length>=1){
	   ...
	   layer.confirm('确认要添加权限给这些用户？',function(index){
	      $("#myform1").submit();
