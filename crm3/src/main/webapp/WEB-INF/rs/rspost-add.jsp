...
<article class="page-container">
	<form action="rspostctrl/addrspost.do" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>职务名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<!-- 如果是添加就没有ID，如果是修改就有ID -->
			<input type="hidden" class="input-text" value="${rspost.postId }" id="postId" name="postId">
				<input type="text" class="input-text" value="${rspost.postName }" placeholder="请输入职务名称" id="postName" name="postName">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="remarkExplain" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)">${rspost.remarkExplain }</textarea>
