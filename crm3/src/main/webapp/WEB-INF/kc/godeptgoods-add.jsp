...
<article class="page-container">
	<form action="goodsindept/addgoodsindept.do" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>仓库编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${sessionScope.getdepoid }" placeholder="" id="depositoryId" name="depositoryId">
			</div>
		</div>
